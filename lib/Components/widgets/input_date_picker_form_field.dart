...
///
class FInputDatePickerFormField extends StatefulWidget {
  ...
  /// If provided, it will specify the keyboard type used. If this is
  /// null, it will default to TextInputType.datetime.
  ...
  @override
  State<FInputDatePickerFormField> createState() =>
      _FInputDatePickerFormFieldState();
}

class _FInputDatePickerFormFieldState extends State<FInputDatePickerFormField> {
  ...
  @override
  void didUpdateWidget(FInputDatePickerFormField oldWidget) {
