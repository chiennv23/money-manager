...
// /// other user interface action. Wrap the button in a [FTooltip] widget and provide
// /// a message which will be shown when the widget is long pressed.
// ///
// /// Many widgets, such as [IconButton], [FloatingActionButton], and
// /// [PopupMenuButton] have a `tooltip` property that, when non-null, causes the
// /// widget to include a [FTooltip] in its build.
// ///
...
// ///
// /// This example show a basic [FTooltip] which has a [Text] as child.
...
// /// `preferBelow` is false, the tooltip will prefer showing above [FTooltip]'s child widget.
...
//   /// [FTooltip.message]. Set this property to true if the app is going to
...
//   static final Set<_FTooltipState> _openedToolTips = <_FTooltipState>{};
...
//       final List<_FTooltipState> openedToolTips =
//           List<_FTooltipState>.from(_openedToolTips);
//       for (final _FTooltipState state in openedToolTips) {
...
//     if (widget.triggerMode != TooltipTriggerMode.manual) {
...
//     FTooltip._openedToolTips.add(this);
//   }

//   void _removeEntry() {
//     FTooltip._openedToolTips.remove(this);
//     _hideTimer?.cancel();
//     _hideTimer = null;
//     _showTimer?.cancel();
//     _showTimer = null;
...
//         childSize.width / 2 - childSize.width * _triangleDxRate,
//         0,
//       ),
//       verticalOffset: verticalOffset,
//       preferBelow: preferBelow,
...
//                 backgroundColor: (decoration as BoxDecoration).color),
//             child: Container(
//               decoration: decoration,
//               padding: padding,
//               margin: margin,
...
//           target: target,
//           verticalOffset: verticalOffset + _triangleHeihgt,
//           preferBelow: preferBelow,
//         ),
//         child: result,
//       ),
...
// const double _triangleDxRate = 0.2;
// const double _triangleWidth = 16;
// const double _triangleHeihgt = 8;

// class _CustomPainter extends CustomPainter {
//   _CustomPainter({this.backgroundColor});
...
//     // - 1 dy de 2 khoi lien nhau
//     final _triangleStartOffset = Offset(
//         size.width * _triangleDxRate - _triangleWidth / 2, size.height - 1);

//     _path.moveTo(_triangleStartOffset.dx, _triangleStartOffset.dy);
//     _path.lineTo(_triangleStartOffset.dx + _triangleWidth / 2,
//         _triangleStartOffset.dy + _triangleHeihgt);
//     _path.lineTo(
//         _triangleStartOffset.dx + _triangleWidth, _triangleStartOffset.dy);
//     _path.lineTo(_triangleStartOffset.dx, _triangleStartOffset.dy);
