...
/// {@tool snippet}
///
/// This sample shows how to use a [FSwitch] in a [ListTile]. The
...
class _FSwitchState extends State<FSwitch> with TickerProviderStateMixin {
...
const double _kSwitchHeight = 40.0;
