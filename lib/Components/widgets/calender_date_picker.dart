...
///    time picker.
///
class FCalendarDatePicker extends StatefulWidget {
  ...
  @override
  State<FCalendarDatePicker> createState() => _FCalendarDatePickerState();
}

class _FCalendarDatePickerState extends State<FCalendarDatePicker> {
  ...
  @override
  void didUpdateWidget(FCalendarDatePicker oldWidget) {
    ...
    return Stack(
      children: <Widget>[
        ...
        _DatePickerModeToggleButton(
          mode: _mode,
          title:
              '${WConvert.month(_currentDisplayedMonthDate.month)}, ${_currentDisplayedMonthDate.year}',
          onTitlePressed: () {
...
class _DayPickerState extends State<_DayPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    const Color enabledDayColor = FColorSkin.title;
    final Color disabledDayColor = colorScheme.onSurface.withOpacity(0.38);
    final Color selectedDayColor = colorScheme.onPrimary;
    final Color selectedDayBackground = FColorSkin.primaryColorHover;
    ...
    while (day < daysInMonth) {
      ...
      var isExpense = widget.moneyList
          .where((element) => element.moneyType == '0')
          .toList()
          .any((element) =>
              element.creMoneyDate.day == day &&
              element.creMoneyDate.month == month &&
              element.creMoneyDate.year == year);

      var isIncome = widget.moneyList
      ...
      if (day < 1) {
        ...
        Widget dayWidget = Container(
          ...
          child: Center(
            child: Text(localizations.formatDecimal(day),
                style: FTypoSkin.bodyText2.copyWith(color: dayColor)),
          ),
        );
        ...
        if (isDisabled) {
              ...
              child: Center(
                child: Text(localizations.formatDecimal(day),
                    style: FTypoSkin.bodyText2
                        .copyWith(color: FColorSkin.disable)),
              ),
            ),
          );
        } else {
          dayWidget = InkResponse(
            ...
            radius: _dayPickerRowHeight / 2 + 3,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: (isIncome == false && isExpense == false)
                        ? Container(
                            height: 5,
                            width: 5,
                          )
...
/// [FCalendarDatePicker], or [showDatePicker] which create full date pickers.
///
/// See also:
///
///  * [FCalendarDatePicker], which provides a Material Design date picker
///    interface.
///
