...
// // ignore_for_file: omit_local_variable_types, missing_return, prefer_asserts_with_message
...
// /// [FSlider] uses this callback to paint the value indicator on the overlay.
// ///
...
//   /// Creates an adaptive [FSlider] based on the target platform, following
//   /// Material design's
...
// class _FSliderState extends State<FSlider> with TickerProviderStateMixin {
...
//     const double _defaultTrackHeight = 8;
...
//     RoundSliderThumbShape(enabledThumbRadius: 4).paint(
//       context,
//       thumbCenter,
//       activationAnimation: _overlayAnimation,
//       enableAnimation: _enableAnimation,
...
//       labelPainter: _labelPainter,
//       parentBox: this,
//       sliderTheme: _sliderTheme.copyWith(thumbColor: Colors.white),
//       textDirection: _textDirection,
//       value: _value,
//       textScaleFactor: textScaleFactor,
//       sizeWithOverflow: screenSize.isEmpty ? size : screenSize,
