...
/// Defines the title font used for [FListTile] descendants of a [ListTileTheme].
///
...
enum ListTileStyle {
  /// Use a title font that's appropriate for a [FListTile] in a list.
  list,

  /// Use a title font that's appropriate for a [FListTile] that appears in a [Drawer].
  drawer,
}

/// An inherited widget that defines color and style parameters for [FListTile]s
/// in this widget's subtree.
///
/// Values specified here are used for [FListTile] properties that are not given
...
class ListTileTheme extends InheritedTheme {
  ...
  /// Creates a list tile theme that controls the color and style parameters for
  /// [FListTile]s, and merges in the current list tile theme, if any.
  ///
  ...
  /// If true then [FListTile]s will have the vertically dense layout.
  final bool dense;

  /// {@template flutter.material.ListTileTheme.shape}
  /// If specified, [shape] defines the [FListTile]'s shape.
  /// {@endtemplate}
  final ShapeBorder shape;

  /// If specified, [style] defines the font used for [FListTile] titles.
  final ListTileStyle style;

  /// If specified, the color used for icons and text when a [FListTile] is selected.
  final Color selectedColor;

  /// If specified, the icon color used for enabled [FListTile]s that are not selected.
  final Color iconColor;

  /// If specified, the text color used for enabled [FListTile]s that are not selected.
  final Color textColor;

  /// The tile's internal padding.
  ///
  /// Insets a [FListTile]'s contents: its [FListTile.leading], [FListTile.title],
  /// [FListTile.subtitle], and [FListTile.trailing] widgets.
  final EdgeInsetsGeometry contentPadding;

  /// If specified, defines the background color for `ListTile` when
  /// [FListTile.selected] is false.
  ///
  /// If [FListTile.tileColor] is provided, [tileColor] is ignored.
  final Color tileColor;

  /// If specified, defines the background color for `ListTile` when
  /// [FListTile.selected] is true.
  ///
  /// If [FListTile.selectedTileColor] is provided, [selectedTileColor] is ignored.
  final Color selectedTileColor;

  /// The horizontal gap between the titles and the leading/trailing widgets.
  ///
  /// If specified, overrides the default value of [FListTile.horizontalTitleGap].
  final double horizontalTitleGap;

  /// The minimum padding on the top and bottom of the title and subtitle widgets.
  ///
  /// If specified, overrides the default value of [FListTile.minVerticalPadding].
  final double minVerticalPadding;

  /// The minimum width allocated for the [FListTile.leading] widget.
  ///
  /// If specified, overrides the default value of [FListTile.minLeadingWidth].
  final double minLeadingWidth;

  /// If specified, defines the feedback property for `ListTile`.
  ///
  /// If [FListTile.enableFeedback] is provided, [enableFeedback] is ignored.
...
/// Where to place the control in widgets that use [FListTile] to position a
/// control next to a label.
///
/// See also:
///
///  * [CheckboxListTile], which combines a [FListTile] with a [Checkbox].
///  * [RadioListTile], which combines a [FListTile] with a [Radio] button.
///  * [SwitchListTile], which combines a [FListTile] with a [Switch].
...
/// {@tool snippet}
///
/// To use a [FListTile] within a [Row], it needs to be wrapped in an
/// [Expanded] widget. [FListTile] requires fixed width constraints,
...
/// See also:
///
///  * [ListTileTheme], which defines visual properties for [FListTile]s.
///  * [ListView], which can display an arbitrary number of [FListTile]s
///    in a scrolling list.
///  * [CircleAvatar], which shows an icon representing a person and is often
///    used as the [leading] element of a ListTile.
///  * [Card], which can be used with [Column] to show a few [FListTile]s.
///  * [Divider], which can be used to separate [FListTile]s.
///  * [FListTile.divideTiles], a utility for inserting [Divider]s in between [FListTile]s.
...
class FListTile extends StatelessWidget {
  ...
  /// The tile's internal padding.
  ///
  /// Insets a [FListTile]'s contents: its [leading], [title], [subtitle],
