...
import '../../Project/2M/Contains/skin/typo_skin.dart';
import '../../Project/2M/LocalDatabase/Models/money_item.dart';
import '../styles/button_size.dart';
import '../styles/color.dart';
import '../styles/icon_data.dart';
...
/// push [FDatePickerDialog] when the button is tapped.
///
/// ```dart
...
/// See also:
///
///  * [showFDateRangePicker], which shows a material design date range picker
...
///
Future<DateTime> showFDatePicker({
  ...
  firstDate = DateUtils.dateOnly(firstDate ?? DateTime(1920, 8));
  ...
  Widget dialog = FDatePickerDialog(
                          ...
                          actions: [
                            FFilledButton(
                              onPressed: () {
                                Navigator.pop(
                                    context,
                                    FDatePickerDialog.selectedDate ??
                                        initialDate);
                              },
...
///
/// It is used internally by [showFDatePicker] or can be directly pushed
/// onto the [Navigator] stack to enable state restoration. See
/// [showFDatePicker] for a state restoration app example.
///
/// See also:
///
///  * [showFDatePicker], which is a way to display the date picker.
class FDatePickerDialog extends StatefulWidget {
  /// A Material-style date picker dialog.
  FDatePickerDialog({
    Key key,
    @required DateTime initialDate,
  ...
  /// Restoration ID to save and restore the state of the [FDatePickerDialog].
  ///
  ...
  final List<MoneyItem> moneyList;

  @override
  State<FDatePickerDialog> createState() => _FDatePickerDialogState();
}

class _FDatePickerDialogState extends State<FDatePickerDialog>
  ...
  void initState() {
    super.initState();
    FDatePickerDialog.selectedDate = widget.initialDate;
  ...
  void _handleDateChanged(DateTime date) {
    ...
    FDatePickerDialog.selectedDate = _selectedDate.value;
  ...
  Widget build(BuildContext context) {
    ...
    FCalendarDatePicker calendarDatePicker() {
      return FCalendarDatePicker(
        key: _calendarPickerKey,
        initialDate: _selectedDate.value,
        firstDate: widget.firstDate,
        moneyList: widget.moneyList,
                ...
                return Theme(
                  data: Theme.of(context).copyWith(
                    colorScheme: ColorScheme.light(
                      primary:
                          FColorSkin.primaryColor, // header background color
                      onPrimary:
                          FColorSkin.onColorBackground, // header text color
                      onSurface: FColorSkin.title,
                    ),
                  ),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    ...
                    children: <Widget>[
                      // TODO: Custom like design in VNPost App
                      // header,
...
/// This is accomplished by enabling state restoration by specifying
/// [MaterialApp.restorationScopeId] and using [Navigator.restorablePush] to
/// push [FDateRangePickerDialog] when the button is tapped.
///
/// ```dart
...
/// See also:
///
///  * [showFDatePicker], which shows a material design date picker used to
///    select a single date.
///  * [DateTimeRange], which is used to describe a date range.
///
Future<DateTimeRange> showFDateRangePicker({
  @required BuildContext context,
  ...
  Widget dialog = FDateRangePickerDialog(
...
///
/// It is used internally by [showFDateRangePicker] or can be directly pushed
/// onto the [Navigator] stack to enable state restoration. See
/// [showFDateRangePicker] for a state restoration app example.
///
/// See also:
///
///  * [showFDateRangePicker], which is a way to display the date picker.
class FDateRangePickerDialog extends StatefulWidget {
  /// A Material-style date range picker dialog.
  const FDateRangePickerDialog({
    Key key,
  ...
  /// Restoration ID to save and restore the state of the [FDateRangePickerDialog].
  ///
  ...
  @override
  State<FDateRangePickerDialog> createState() => _FDateRangePickerDialogState();
}

class _FDateRangePickerDialogState extends State<FDateRangePickerDialog>
    with RestorationMixin {
  _RestorableDatePickerEntryMode _entryMode;
