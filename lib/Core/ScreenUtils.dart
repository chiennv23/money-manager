...
class ScreenUtil {
  ...
  /// Size of the screen phone in Views Design , px
  num uiWidthPx;
  num uiHeightPx;
  ...
  /// Adapted to the device width of the Views Design.
  /// Height can also be adapted according to this to ensure no deformation ,
  /// if you want a square
  num setWidth(num width) => width * scaleWidth;

  /// Highly adaptable to the device according to Views Design
  /// It is recommended to use this method to
  /// achieve a high degree of adaptation
  /// when it is found that one screen in the Views design
